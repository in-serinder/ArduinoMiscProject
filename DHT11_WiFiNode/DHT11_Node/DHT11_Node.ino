...
void MQTTCallBack(char *topic, byte *payload, unsigned int len)
{
  ...
  if (str == "GET")
  {
    pc.publish(MQTT_TOPIC, (">T" + String(dht11.readTemperature()) + " H" + String(dht11.readHumidity())).c_str());
    Serial.println("Command--" + str);
  }

  if (str == "GET_TEMP")
  {
    pc.publish(MQTT_TOPIC, (">T" + String(dht11.readTemperature())).c_str());
    Serial.println("Command--" + str);
  }

  if (str == "GET_HUM")
  {
    pc.publish(MQTT_TOPIC, (">H" + String(dht11.readHumidity())).c_str());
    Serial.println("Command--" + str);
  }
...
{
  String data = "Hello DHT_NODE " + WiFi.macAddress() + " Started";
